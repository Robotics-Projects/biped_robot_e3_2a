...
from gazebo_connection_biped import GazeboConnection
from joint_publisher import JointPub
from biped_state import BipedState
from controllers_connection_biped import ControllersConnection

#register the training environment in the gym as an available one
reg = register(
    id='Biped-v0',
    entry_point='biped_env:BipedEnv',
